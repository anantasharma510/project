...
<head>
    ...
    <title>BCA Seventh Semester</title>
...
<body>
    ...
    <h2>Welcome to BCA Seventh Semester!</h2>
    
    <section id="main-content">
        <!-- Your main content goes here -->
        <div class="container">
            <a href="syllabus7.php">Syllabus</a>
            <a href="assignment7.php">Assignment</a>
            <a href="labreport7.php">Lab Report</a>
            <a href="notice7.php">Notice</a>
            <a href="messages7.php">Messages</a>
            
            <!-- Add more navigation links as needed -->
        </div>
    </section>
    <footer>
        <p>&copy; 2024 BCA Seventh Semester. All rights reserved.</p>
    </footer>
</body>
</html>
