...
<head>
    ...
    <title>BCA Fourth Semester</title>
...
<body>
    ...
    <h2>Welcome to BCA Fourth Semester!</h2>
    
    <section id="main-content">
        <!-- Your main content goes here -->
        <div class="container">
            <a href="syllabus4.php">Syllabus</a>
            <a href="assignment4.php">Assignment</a>
            <a href="labreport4.php">Lab Report</a>
            <a href="notice4.php">Notice</a>
            <a href="messages4.php">Messages</a>
            
            <!-- Add more navigation links as needed -->
        </div>
    </section>
    <footer>
        <p>&copy; 2024 BCA Fourth Semester. All rights reserved.</p>
    </footer>
</body>
</html>
