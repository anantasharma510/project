...
<head>
    ...
    <title>Pre Board Exam Attendance - First Semester</title>
...
<body>
    <div class="container">
        <h1>Pre Board Attendance Management BCA FIRST SEMESTER</h1>
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='u1.php?id=" . $row["id"] . "'>Update</a> | <a href='del1.php?id=" . $row["id"] . "' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>";
                    echo "</tr>";
                }
            } else {
