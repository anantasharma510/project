...
<head>
    ...
    <title>BCA Third Semester</title>
...
<body>
    ...
    <h2>Welcome to BCA Third Semester!</h2>
    
    <section id="main-content">
        <!-- Your main content goes here -->
        <div class="container">
            <a href="syallabus3.php">Syllabus</a>
            <a href="assignment3.php">Assignment</a>
            <a href="labreport3.php">Lab Report</a>
            <a href="notice3.php">Notice</a>
            <a href="messages3.php">Messages</a>
