...
<head>
    ...
    <title>BCA Second Semester</title>
...
<body>
    ...
    <h2>Welcome to BCA Second Semester!</h2>
    
    <section id="main-content">
        <!-- Your main content goes here -->
        <div class="container">
            <a href="syallabus2.php">Syllabus</a>
            <a href="assignment2.php">Assignment</a>
            <a href="labreport2.php">Lab Report</a>
            <a href="notice2.php">Notice</a>
    ...
    <footer>
        <p>&copy; 2024 BCA Second Semester. All rights reserved.</p>
    </footer>
</body>
</html>
