...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['student_id']) && isset($_POST['course_id']) && isset($_POST['date']) && isset($_POST['status'])) {
        ...
        $sql = "INSERT INTO attendance4 (student_id, course_id, date, status) VALUES ('$student_id', '$course_id', '$date', '$status')";
...
<head>
    ...
    <title>Pre Board Exam Attendance - FOURTH Semester</title>
...
<body>
<div class="container">
    <h1>Pre Board Attendance Management BCA FOURTH SEMESTER</h1>
    ...
    <table>
        ...
        $sql = "SELECT * FROM attendance4"; // Corrected table name to 'attendance4'
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='u4.php?id=" . $row["id"] . "'>Update</a> | <a href='del4.php?id=" . $row["id"] . "' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>"; 
                echo "</tr>";
            }
        } else {
