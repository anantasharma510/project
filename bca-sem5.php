...
<head>
    ...
    <title>BCA Fifth Semester</title>
...
<body>
    ...
    <h2>Welcome to BCA Fifth Semester!</h2>
    
    <section id="main-content">
        <!-- Your main content goes here -->
        <div class="container">
            <a href="syllabus5.php">Syllabus</a>
            <a href="assignment5.php">Assignment</a>
            <a href="labreport5.php">Lab Report</a>
            <a href="notice5.php">Notice</a>
            <a href="messages5.php">Messages</a>
            
            <!-- Add more navigation links as needed -->
        </div>
    </section>
    <footer>
        <p>&copy; 2024 BCA Fifth Semester. All rights reserved.</p>
    </footer>
</body>
</html>
